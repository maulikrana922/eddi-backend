            ...
            if request.method == POST_METHOD:
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            pdfkit.from_string(template,f"/var/www/html/eddi-backend/media/{invoice_number}.pdf")
                        except:
                            pass
                        record = {}
                        try:
                            ...
                            "invoice_file" : f"/var/www/html/eddi-backend/media/{invoice_number}.pdf",
                        ...
                        try:
                            email_msg.attach_file(f"/var/www/html/eddi-backend/media/{invoice_number}.pdf") 
                        except:
                            pass
